...
I adore Ideogram 4! It's compositional power and generational quality is unmatched in my opinion. I'm also a purist and control freak.....I want complete creative license on every level. So I have dedicated the last couple of months to creating **<ins>ApoGalleria</ins>**, and to satiate my new custom nodes I also built a colossal **[Visual Aesthetics Library](https://github.com/ApoloniArt/Visual-Aesthetics-Library)** that contains over 50,000+ pieces of captioned art inspiration, also available directly from me. Both are personal projects created to fill my exact needs, that I now decided to make available to the community.
