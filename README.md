...
**ApoGalleria** is my ComfyUI custom node suite for collecting, viewing, and reusing a library of image reference json captions, primarily for Ideo4, but with the use of my sibling nodes the stored json's can be converted for inference across multiple model architectures. One visual library manager
